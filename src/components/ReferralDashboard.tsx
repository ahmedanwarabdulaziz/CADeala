...
export default function ReferralDashboard() {
  ...
  // Check if customer has business association
  if (userRole?.role === 'Customer' && !userRole?.businessAssociation) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center py-8">
          <Share2 className="h-12 w-12 text-gray-400 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-gray-900 mb-2">No Business Association</h3>
          <p className="text-gray-600 mb-4">You need to be associated with a business to use referral features.</p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>How to get started:</strong> Ask a business owner for their referral link or signup link to become associated with their business.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      {referral.status === 'completed' && (
                        <span className="ml-2 text-green-600 font-medium">✓ Successfully joined</span>
                      )}
                    </p>
                  </div>
                </div>
